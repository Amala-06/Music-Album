...
<html>
    <head>
		...
		background-color : white;
            ...
            .all{ border: 1px solid black; border-radius: 10%; box-shadow: 0px 1px 8px 3px palevioletred;
		 text-align: center; margin: 50px 400px; padding: 5px 5px; font-size: 20px; background-color: white;}
